...
ваших здібностей та швидко повідомити результат.
            ...
            <div className={styles.lastBlock}>
                ...
                <div class="p-6">
                    ...
                    <p class="text-base">
                        Команда, яка налічує понад 50 професіоналів. Наша команда має власний офіс, хостинг, проводить навчання кадрів, здійснює контроль якості кожного проекту. За час своєї роботи ми розробили сотні інтернет-магазинів, які працюють у всіх країнах світу, продавши своїм замовникам тисячі товарів на добу.
                    </p>
                    </div>
                </div>
            </div>
